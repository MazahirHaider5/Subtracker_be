...
exports.verifyPasswordResetOtp = exports.resendPasswordResetOtp = exports.requestPasswordResetOtp = exports.signup = exports.socialLogin = exports.logout = exports.resetPassword = exports.verifyOtp = exports.resendOtp = exports.requestOtp = exports.verifySignupOtp = exports.login = void 0;
...
const login = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const user = yield users_model_1.default.findOne({ email }).select("id name email password photo phone language currency is_biomatric is_face_auth is_two_factor is_email_notification stripe_customer_id user_type is_verified is_active signup_date last_login fcmToken");
        if (!user) {
            return res
                .status(404)
